...
sim_nobs %>% 
  ...
  kableExtra::pack_rows(group_label = "$n = 50$", 1, 3) %>% 
  kableExtra::pack_rows(group_label = "$n = 500$", 4, 6) %>% 
  kableExtra::pack_rows(group_label = "$n = 5000$", 7, 9)
