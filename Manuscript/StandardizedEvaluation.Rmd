...
<!-- als je perf based sims doet, dan kijk je wel daarnaar. -->
...
[Briefly introduce missingness mechanisms here and show potential problems, but without simulation results (moved to separate section). This part should contain: 1) definitions of mechanisms, 2) that MCAR is often ignored, while it's the minimum requirement and reference, and sometimes realistic in practice, 3) that MAR can be generated *spuriously* if the correlation between variables is low, and 4) that MNAR is often ignored, while it may be the most realistic in practice. And finally something about types of M(N)AR, but what are specific problems with that? ref dance paper rianne]
...
<!-- als inf het doel is, dan moet je de varianties juist krijgen dus kom je niet weg met m = 1 (want geen onderscheid tussen obs en imp) -->
...
<!-- [Checklist voor iedere sim studie met alle parameters die we bespreken] -->

<!-- - doel -->

<!-- - 11 punten van stef -->

<!-- - andere punten uit dit paper -->

<!-- - welke variables/features vormen imp model en welke analysis model (congenial, meng 94) -->

<!-- - cross validation? -->

<!-- als pfd met check boxes? -->
