...
2 & Data generation                                                                  \\ \cline{2-2}
$\square$  & Data source (e.g. model-based or design-based, sampling variance)                                           \\
...
3 & Missingness generation                                                                \\ \cline{2-2}
$\square$  & Missingness mechanism (incl. type or functional form of the missing data model)  \\
$\square$  & Missingness pattern (incl. missingness proportions)                                 \\ \hline 
4 & Methods                                                                    \\ \cline{2-2}
...
$\square$  & Reference methods (e.g. complete case analysis)                                    \\ \hline 
